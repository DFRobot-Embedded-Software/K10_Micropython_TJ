...
file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/qstr_sources.txt "")
foreach(src ${MICROPY_SOURCE_QSTR})
    file(APPEND ${CMAKE_CURRENT_BINARY_DIR}/qstr_sources.txt "${src}\n")
endforeach()
...
add_custom_command(
    ...
    COMMAND ${Python3_EXECUTABLE} ${MICROPY_PY_DIR}/makeqstrdefs.py pp ${CMAKE_C_COMPILER} -E output ${MICROPY_GENHDR_DIR}/qstr.i.last cflags ${MICROPY_CPP_FLAGS} -DNO_QSTR cxxflags ${MICROPY_CPP_FLAGS} -DNO_QSTR sources @${CMAKE_CURRENT_BINARY_DIR}/qstr_sources.txt
